...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-stone-50 font-sans text-stone-800">
      ...
      {/* --- Hero / Header --- */}
      <div className="bg-rose-900 text-white py-16 px-4 text-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 mb-20">
        <div className="bg-white rounded-xl shadow-xl overflow-hidden flex flex-col lg:flex-row border border-stone-200">
          ...
          <div className="lg:w-2/5 bg-stone-900 text-stone-300 p-10 flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 -mr-10 -mt-10 w-40 h-40 bg-rose-900 rounded-full opacity-20 blur-3xl"></div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="bg-rose-900 p-3 rounded-lg text-white shrink-0">
                    <FaPhoneAlt />
                  </div>
                  <div>
                    <p className="text-sm text-stone-400 uppercase tracking-wider mb-1">Phone</p>
                    <p className="text-white hover:text-rose-400 transition-colors">+91 98765 43210</p>
                    <p className="text-white hover:text-rose-400 transition-colors">+91 12345 67890</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white hover:text-rose-400 transition-colors">support@traditionalsite.com</p>
                    <p className="text-white hover:text-rose-400 transition-colors">custom@traditionalsite.com</p>
                  </div>
                </div>
            ...
            <div className="mt-12">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 rounded-full bg-stone-800 flex items-center justify-center hover:bg-rose-900 hover:text-white transition-all text-white"><FaInstagram /></a>
                <a href="#" className="w-10 h-10 rounded-full bg-stone-800 flex items-center justify-center hover:bg-rose-900 hover:text-white transition-all text-white"><FaFacebookF /></a>
                <a href="#" className="w-10 h-10 rounded-full bg-stone-800 flex items-center justify-center hover:bg-rose-900 hover:text-white transition-all text-white"><FaWhatsapp /></a>
              </div>
            </div>
          </div>
            ...
            {submitted ? (
              <div className="h-full flex flex-col items-center justify-center text-center animate-fadeIn">
                ...
                <button 
                  ...
                  className="mt-8 text-rose-900 font-semibold hover:underline"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-stone-50 border border-stone-200 focus:border-rose-900 focus:ring-1 focus:ring-rose-900 outline-none transition-all"
                ...
                <div>
                  ...
                  <div className="relative">
                    <select 
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 rounded-lg bg-stone-50 border border-stone-200 focus:border-rose-900 focus:ring-1 focus:ring-rose-900 outline-none appearance-none transition-all"
                    >
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 rounded-lg bg-stone-50 border border-stone-200 focus:border-rose-900 focus:ring-1 focus:ring-rose-900 outline-none transition-all resize-none"
                ...
                <button 
                  ...
                  className="w-full bg-rose-900 text-white font-bold py-3 rounded-lg hover:bg-rose-800 transition-all flex items-center justify-center gap-2 shadow-lg shadow-rose-900/20 disabled:opacity-70"
                >
        ...
        <div className="max-w-3xl mx-auto mt-20">
          <h2 className="text-3xl font-serif font-bold text-center text-rose-900 mb-8">Frequently Asked Questions</h2>
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="bg-white border border-stone-200 rounded-lg overflow-hidden">
                ...
                >
                  ...
                  {openFaq === index ? <FaChevronUp className="text-rose-900"/> : <FaChevronDown className="text-stone-400"/>}
                </button>
                <div 
      ...
      <div className="w-full h-96 bg-stone-200 relative grayscale">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-stone-900/10">
            <button className="bg-white text-stone-900 px-6 py-3 rounded-full font-bold shadow-xl flex items-center gap-2 hover:bg-rose-900 hover:text-white transition-colors">
